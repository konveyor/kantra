...
// noCleanupFlag must match the persistent flag registered on the root command.
const noCleanupFlag = "no-cleanup"

const OpenRewriteRecipesPath = "/opt/openrewrite"

// path in container for maven settings file
const settingsFileMountPath = "/tmp/source-app/input"
