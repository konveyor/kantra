...
require (
	...
	github.com/konveyor/agentic-controller/api v0.0.0-00010101000000-000000000000
...
// TODO: the agentic-controller api module is not yet tagged; replace it with a
// pinned pseudo-version (go get github.com/konveyor/agentic-controller/api@<commit>)
// and drop this replace once a release is published. Requires the sibling
// agentic-controller checkout for local development.
replace github.com/konveyor/agentic-controller/api => ../agentic-controller/api
