...
require (
	...
	github.com/konveyor/analyzer-lsp/external-providers/java-external-provider v0.0.0-20251206041249-2a753870572f
...
require (
	...
	github.com/konveyor/analyzer-lsp v0.9.0-alpha.1.0.20251211203400-1bef9aeca7af
