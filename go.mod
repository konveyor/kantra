...
require (
	...
	github.com/konveyor/asset-generation v0.1.8
...
require (
	...
	github.com/konveyor/analyzer-lsp/external-providers/java-external-provider v0.0.0-20250801142813-c761279fb128
